      ...
      <main className="relative overflow-hidden">
        <div className="relative container mx-auto px-4 space-y-24 py-8">
          ...
          <section className="text-center space-y-8 py-16 relative">
            <div className="absolute top-10 left-10 text-6xl opacity-10 rotate-12 text-black">
              ♔
            </div>
            <div className="absolute top-20 right-16 text-4xl opacity-10 -rotate-12 text-black">
              ♛
            </div>
            <div className="absolute bottom-10 left-20 text-5xl opacity-10 rotate-45 text-black">
              ♞
            </div>
            ...
            <div className="space-y-6 relative z-10">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Challenge AI opponents, compete with players worldwide, and
                unlock your chess potential with our
          ...
          <section className="space-y-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <FeatureCard
                ...
                iconColor="text-primary" // Changed from text-blue-500
                badge="Smart AI"
              />
              ...
              <FeatureCard
                ...
                iconColor="text-primary" // Changed from text-green-500
                badge="Live"
                highlighted
              />
              ...
              <FeatureCard
                ...
                buttonHref="#"
                iconColor="text-primary" // Changed from text-yellow-500
                badge="Soon"
                disabled
              />
            </div>
          ...
          <section className="relative">
            ...
            <div className="relative p-8 md:p-16 space-y-12">
              <div className="text-center space-y-4">
                <h2 className="text-4xl md:text-5xl font-bold">
                  Why <span className="text-primary">GroundChess</span>?{" "}
                  {/* Changed ChessHub to GroundChess */}
                </h2>
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                  Experience chess with cutting-edge technology and proven
                  training methods
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <BenefitCard
                  ...
                  iconColor="text-primary" // Changed from text-indigo-500
                />
              </div>
            </div>
          </section>
              ...
              {[
                {
                  name: "Sarah Chen",
                  rating: "1850 → 2100",
                  text: "GroundChess's AI training helped me break through my plateau. The personalized feedback is incredible!", // Changed ChessHub to GroundChess
                  avatar: "SC",
                },
                {
          ...
          <section className="relative overflow-hidden rounded-3xl">
            ...
            <div className="absolute top-0 right-0 text-9xl opacity-10 text-primary-foreground">
              ♔
            </div>
            <div className="absolute bottom-0 left-0 text-7xl opacity-10 text-primary-foreground">
              ♛
            </div>

            <div className="relative text-center p-8 md:p-16 space-y-8 text-primary-foreground">
...
function FeatureCard({
  ...
  return (
    <Card
      className={`relative group hover:shadow-xl transition-all duration-300 border-border ${
        highlighted
...
function BenefitCard({
  ...
  return (
    <div className="group text-center space-y-4 p-6 rounded-xl hover:bg-accent/50 transition-colors duration-300 border border-transparent hover:border-border">
      <Icon
